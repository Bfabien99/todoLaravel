...
<form action="{{route('todos.store')}}" method="post">@csrf
        ...
        <div>
            ...
            <input class="outline-none border p-2" type="text" name="title" placeholder="Enter title" id="title" value="{{old('title')}}">
            @error('title')
        ...
        <div>
            ...
            <textarea class="outline-none border p-2" name="detail" id="detail" placeholder="Some information about the Todo...">{{old(key: 'detail')}}</textarea>
            @error('detail')
                <p class="text-red-400"><span class="font-medium">x</span> {{$message}}</p>
            @enderror
        </div>
        <div>
            ...
            <input class="outline-none border p-2" type="date" name="limit_date" id="limit_date" value="{{old('limit_date')}}">
            @error('limit_date')
                <p class="text-red-400"><span class="font-medium">x</span> {{$message}}</p>
            @enderror
